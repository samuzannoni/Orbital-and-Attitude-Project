...
t_span_dep = linspace(t_dep_in,t_dep_fin,1000); % time vector for departure window (be careful it's in days!!!)
...
t_span_arr = linspace(t_arr_in,t_arr_fin, 1000); % time vector for departure window (be careful it's in days!!!)
